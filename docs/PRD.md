...
<!--
_____ forecast flow diagram (start)
-->
...
<head>
  ...
  <title>Sandvik Forecast Tool — Forecast Flow Diagram</title>
  ...
  <style>
    * { margin: 0; padding: 0; box-sizing: border-box; }
    ...
    .subtitle { color: #94a3b8; font-size: 0.8rem; margin-left: 1.5rem; }
...
<div class="container">
  <div class="header">
    <div class="header-row">
      ...
      <h1>销售预测业务流程 — Forecast Flow Diagram</h1>
    </div>
    <p class="subtitle">Sandvik Forecast Tool · PRD §3 业务流程 · v0.4</p>
  </div>
  ...
  <p class="footer">Sandvik Forecast Tool · PRD §3 业务流程 · 预测流图 · v0.4</p>
</div>
</body>
</html>
...
<!--
_____ forecast flow diagram (end)
-->
...
<!--
_____ functional architecture diagram (start)
-->
...
<head>
  <meta charset="UTF-8">
  <meta name="viewport" content="width=device-width, initial-scale=1.0">
  <title>Sandvik Forecast Tool — Functional Architecture</title>
  <link href="https://fonts.googleapis.com/css2?family=JetBrains+Mono:wght@400;500;600;700&display=swap" rel="stylesheet">
  <style>
    * { margin: 0; padding: 0; box-sizing: border-box; }
    body { font-family: 'JetBrains Mono', monospace; background: #020617; min-height: 100vh; padding: 2rem; color: white; }
...
<div class="container">
  <div class="header">
    <div class="header-row">
      <div class="pulse-dot"></div>
      <h1>功能架构图 — Functional Architecture</h1>
    </div>
    <p class="subtitle">Sandvik Forecast Tool · PRD §4 功能模块 · v0.4 · 位于功能模块总览之前</p>
  </div>
  <div class="diagram-container">
    <svg viewBox="0 0 1100 740">
      <defs>
        <marker id="a" markerWidth="8" markerHeight="6" refX="8" refY="3" orient="auto"><polygon points="0 0, 8 3, 0 6" fill="#64748b"/></marker>
        <marker id="a-cyan" markerWidth="8" markerHeight="6" refX="8" refY="3" orient="auto"><polygon points="0 0, 8 3, 0 6" fill="#22d3ee"/></marker>
        <marker id="a-green" markerWidth="8" markerHeight="6" refX="8" refY="3" orient="auto"><polygon points="0 0, 8 3, 0 6" fill="#34d399"/></marker>
        <marker id="a-amber" markerWidth="8" markerHeight="6" refX="8" refY="3" orient="auto"><polygon points="0 0, 8 3, 0 6" fill="#fbbf24"/></marker>
  ...
  <p class="footer">Sandvik Forecast Tool · 功能架构图 · PRD §4 功能模块 · v0.4</p>
</div>
</body>
</html>
...
<!--
_____ functional architecture diagram (end)
-->
...
<!--
_____ technical architecture diagram (start)
-->
...
<head>
  <meta charset="UTF-8">
  <meta name="viewport" content="width=device-width, initial-scale=1.0">
  <title>Sandvik Forecast Tool — Technical Architecture</title>
  <link href="https://fonts.googleapis.com/css2?family=JetBrains+Mono:wght@400;500;600;700&display=swap" rel="stylesheet">
  <style>
    * { margin: 0; padding: 0; box-sizing: border-box; }
    body { font-family: 'JetBrains Mono', monospace; background: #020617; min-height: 100vh; padding: 2rem; color: white; }
    ...
    .header { margin-bottom: 1.5rem; }
    .header-row { display: flex; align-items: center; gap: 1rem; margin-bottom: 0.5rem; }
    .pulse-dot { width: 10px; height: 10px; background: #a78bfa; border-radius: 50%; animation: pulse 2s infinite; }
    @keyframes pulse { 0%,100%{opacity:1} 50%{opacity:0.5} }
    h1 { font-size: 1.25rem; font-weight: 700; }
    .subtitle { color: #94a3b8; font-size: 0.8rem; margin-left: 1.5rem; }
    .diagram-container { background: rgba(15,23,42,0.5); border-radius: 1rem; border: 1px solid #1e293b; padding: 1.5rem; overflow-x: auto; }
...
<div class="container">
  <div class="header">
    <div class="header-row">
      <div class="pulse-dot"></div>
      <h1>技术架构图 — Technical Architecture</h1>
    </div>
    <p class="subtitle">Sandvik Forecast Tool · PRD §8 技术架构 · v0.4</p>
  </div>
  <div class="diagram-container">
    <svg viewBox="0 0 1100 800">
      <defs>
        ...
        <marker id="arr-green" markerWidth="8" markerHeight="6" refX="8" refY="3" orient="auto"><polygon points="0 0, 8 3, 0 6" fill="#34d399"/></marker>
        <marker id="arr-amber" markerWidth="8" markerHeight="6" refX="8" refY="3" orient="auto"><polygon points="0 0, 8 3, 0 6" fill="#fbbf24"/></marker>
        <marker id="arr-violet" markerWidth="8" markerHeight="6" refX="8" refY="3" orient="auto"><polygon points="0 0, 8 3, 0 6" fill="#a78bfa"/></marker>
        <pattern id="grid" width="40" height="40" patternUnits="userSpaceOnUse"><path d="M 40 0 L 0 0 0 40" fill="none" stroke="#1e293b" stroke-width="0.5"/></pattern>
      </defs>
      <rect width="100%" height="100%" fill="url(#grid)"/>
  ...
  <p class="footer">Sandvik Forecast Tool · 技术架构图 · PRD §8 技术架构 · v0.4</p>
</div>
</body>
</html>
...
<!--
_____ technical architecture diagram (end)
-->
